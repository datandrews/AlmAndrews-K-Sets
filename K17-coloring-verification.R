...
# Is complete bipartite graph formed by vertex sets x & y monochromatic? It would be if the slice of
# the color table is all true or all false
...
cat(paste("Success: no monochromatic K_3,3 nor K_5,2 subgraphs found.\n"))
